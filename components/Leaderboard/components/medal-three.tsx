...
export const MedalThree = ({ user, sortBy }: Props) => {
  if (!user) return null;
  return (
    <div className="flex-1 rounded-lg bg-[#151515] border-2 border-neutral-600 bg-linear-to-t from-[#151515] to-neutral-800">
      <div className="flex flex-col gap-6 h-full items-start p-6 relative overflow-hidden">
        <div className="relative">
          <img
            src="/leaderboard/avatar-5.avif"
            alt="first"

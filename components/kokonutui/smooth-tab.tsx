...
const DEFAULT_TABS: TabItem[] = [
    ...
    cardContent: (
      <div className="relative h-full">
        ...
        <div className="relative flex h-full flex-col p-6 text-white">
          <h3 className="font-semibold text-2xl tracking-tight">Clarity</h3>
          <p className="mt-2 text-sm text-white/80 max-w-[90%]">
            the market question must be clear, easily understandable, and
...

  {
    ...
    cardContent: (
      <div className="relative h-full">
        ...
        <div className="relative flex h-full flex-col p-6 text-white">
          <h3 className="font-semibold text-2xl tracking-tight">Resolution</h3>
          <p className="mt-2 text-sm text-white/80 max-w-[90%]">
            every market must have a fixed end date and time or a clearly
            defined resolving event
          </p>
        </div>
      </div>
    ),
    ...
    cardContent: (
      <div className="relative h-full">
        ...
        <div className="relative flex h-full flex-col p-6 text-white">
          ...
          <p className="mt-2 text-sm text-white/80 max-w-[90%]">
            outcomes must be verifiable using reliable public information, such
            as a website news, article or social media post with verified handle
            (?)
          </p>
        </div>
      </div>
  ...
  //         </h3>
  //         <p className="mt-2 text-sm text-white/80 max-w-[90%]">
  //           All markets are reviewed by our team within 1 hour before going
  //           live.
  //         </p>
  //       </div>
  //     </div>
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="relative mb-4 flex-1">
        <div className="relative h-[200px] w-full rounded-xl">
          <div className="absolute inset-0 overflow-hidden rounded-lg">
            ...
            >
              <motion.div
                animate="center"
                className="absolute inset-0 h-full w-full bg-linear-to-b from-neutral-900 to-neutral-950 will-change-transform text-white text-balance"
                custom={direction}
                exit="exit"
                initial="enter"
                key={`card-${selected}`}
      ...
      >
        ...
        <div className="relative z-[2] grid w-full grid-cols-3 gap-1">
          {items.map((item) => {
